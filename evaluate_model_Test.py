...
Usage:
    ...
    $ spark-submit --driver-memory 8g --executor-memory 16g --deploy-mode cluster evaluate_model_Test.py cf_test_encode.parquet > results_test.txt 2>&1
...
def main(spark, test_file):
    ...
    results_dict = {"ALS_Model":"Results_ALS", "ALS_log_Model":"Results_ALS_Log", "ALS_drop_Model":"Results_ALS_Drop"}
